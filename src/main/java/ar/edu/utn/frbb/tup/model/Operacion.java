...
import ar.edu.utn.frbb.tup.service.TransferenciaDto;
...
public class Operacion {
    ...
    public Operacion(long numeroMovimiento, LocalDate fecha, double monto, TipoMovimiento tipo, String descripcion) {
    ...
    public void save(Cuenta cuenta, Object operacion, TipoMovimiento tipo, String descripcion) {
        Operacion transaccion = new Operacion();
