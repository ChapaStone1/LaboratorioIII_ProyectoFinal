...
public class RetirosService {
    ...
    private CuentaService cuentaService;
     ...
     public RespuestaDto realizarRetiro(RetirosDto retiroDto) throws TipoMonedaInvalidoException, InputErrorException, NotExistCuentaException, NoAlcanzaException {
    ...
    private RespuestaDto retirar(Cuenta cuenta, RetirosDto depositoDto) {
